...
public class Tinh implements Serializable{
	...
	public static ArrayList<Tinh> getDSTinh() {
		...
		String[] arr_tinh = { "An Giang", "Bà rịa – Vũng tàu", "Bắc Giang", "Bắc Kạn", "Bạc Liêu", "Bắc Ninh",
				...
				"Thừa Thiên Huế", "Tiền Giang", "Thành phố Hồ Chí Minh", "Trà Vinh", "Tuyên Quang", "Vĩnh Long",
				"Vĩnh Phúc", "Yên Bái", };
